                ...
                <table class="list ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="26%" align="left" valign="top"><strong>Desde</strong><br>
                            ...
                            <td width="32%" align="center" valign="top">
                                ...
                                <input type="hidden" name="IDMENU" value="112" readonly="YES">
                                <input type="hidden" name="AX" value="3B" readonly="YES">
